...
ifttt_auth = "gqO6FteCv-5IH9VTAOHSyYZZC_-lg_55FbshjAsWHgk"
def fetchStatus(partNum):
  ...
  subHeader = ""
  if  partNum == "MLY43ZP/A": # midnight
    subHeader="Midnight"
  elif  partNum == "MLY23ZP/A":
    subHeader = "Starlight"
  elif  partNum ==  "MLXX3ZP/A":
    subheader = "Space Grey" # spacegrey
  elif  partNum == "MLY03ZP/A":
    subheader = "Silver"
...
def postWebhook(partNum, subHeader, pickUpEligibility, showDeliveryOptions, isBuyable):
  payload = {
    "info": subHeader + "," + "Pickup:" + str(pickUpEligibility) + "," + "Delivery:" + str(showDeliveryOptions) + "," + "Buyable:" + str(isBuyable),
  }
